...
document.addEventListener('DOMContentLoaded', function() {
	// Correctly targets the 'ingame-toolbar' element
	const buttonsContainer = document.getElementById('ingame-toolbar');
	let inactivityTimer;
	...
	function resetTimer() {
		...
		showButtons();
		inactivityTimer = setTimeout(hideButtons, 2000); // Hides after 2 seconds
	}
